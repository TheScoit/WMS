...
const clientId = "BF76aLECbxLaV0v_GoQisi5m_fZRnRJ3-VYR6toaVvUeqkiIj-f84EEHFcA2glmqVRrzCTX-uoyEb3pO9fDUpvU";
        ...
        <div className="flex items-center">
          ...
          <Link href="/" className="flex items-center">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-base md:text-lg text-gray-800">WasteManagement</span>
              <span className="text-[8px] md:text-[10px] text-gray-500 -mt-1">SwachBharatKaIrada</span>
            </div>
          </Link>
        </div>
        {!isMobile && (
